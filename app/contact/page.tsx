          ...
          {submitted ? (
            <div className="success-wrap">
              ...
              <p className="success-text">
                Thanks, <strong>{formData.name}</strong>! Our team will review your details
                and get in contact with you shortly.
              </p>
              <a href="mailto:irahtech69@gmail.com" className="email-chip" style={{ textDecoration: "none" }}>
                <div className="email-chip-icon">✉</div>
                <div>
                  <div className="email-chip-label">Reach us directly</div>
