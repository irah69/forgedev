...
function ValueCard({ item }) {
  ...
  return (
    ...
    >
      ...
      <p style={{
        margin: 0, fontSize: "13px", color: "#8892B0", lineHeight: 1.7,
      }}>
        {item.desc}
      </p>
  ...
  return (
    <>
      <style>{`
        ...
        .about-section { animation: fadeIn 0.6s ease both; }
      ...
      <main style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <section style={{
            ...
            <div style={{
              ...
              <div style={{ animation: "fadeUp 0.8s ease both 0.2s" }}>
                ...
                <p style={{
                  margin: 0, fontSize: "clamp(14px,1.4vw,16px)",
          ...
          <div className="about-divider" style={{ margin: "0 clamp(24px,6vw,100px) 0" }} />
              ...
              <div style={{ animation: "fadeUp 0.7s ease both 0.1s" }}>
                ...
                <div style={{ marginTop: "48px", display: "flex", flexDirection: "column", gap: "0" }}>
                  {[
                    ...
                    <div key={item.year} style={{ display: "flex", alignItems: "center", gap: "16px", padding: "14px 0", borderBottom: "1px solid rgba(123,110,246,0.1)" }}>
                      <span style={{ fontSize: "11px", fontFamily: "monospace", color: "#7B6EF6", letterSpacing: "0.1em", minWidth: "36px" }}>{item.year}</span>
                      <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: i % 2 === 0 ? "#7B6EF6" : "#4FC3F7", flexShrink: 0 }} />
                      <span style={{ fontSize: "13px", color: "#8892B0", letterSpacing: "0.06em" }}>{item.label}</span>
                    </div>
                  ))}
                </div>
              </div>
